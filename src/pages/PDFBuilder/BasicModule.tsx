...
const BasicModule = ({
  ...
  >
    <View style={{ marginBottom: 20, padding: 60, paddingTop: 20 }}>
      <View
        style={{
          flexDirection: 'row',
          justifyContent: 'space-between',
      ...
      <View>
        ...
        <Text style={globalStyles.paragraph}>
          ...
          contribute to the transition towards a more sustainable economy. These actions help
          mitigate negative impacts while reinforcing positive outcomes for both society and the
          environment. They form an integral part of our sustainability strategy and further
          reinforce our long-term commitment to a more responsible and sustainable future.
        </Text>
        <Text style={globalStyles.paragraph}>
          {nome_empresa} has implemented a range of practices designed to contribute to the
          transition towards a more sustainable economy.
        </Text>
        <Text style={globalStyles.paragraph}>{practices_sustainable_economy}</Text>
      </View>
    </View>
    <BarrasDoFundo pageNumber={4} />
  </View>
);
